     ...
     <div class="col-md-offset-1 col-md-10" style="position: relative;top: -22px">
        <div class="panel panel-default card" style="border-radius: 0px;">
          <div class="panel-body">
                    <p><h4>Welcome - <b style='color:red;'><?php echo $profile['name']; ?></b></h4>  <a href = "logout.php" style="float:right;" class="btn btn-warning">Sign Out</a>
               </p>
                    ...
                    <div class='row'>
                        <div class="col-md-3">
                             ...
                             <center>
                                     ...
                                     <img style="width: 150px;height: 150px;" src="data:image/jpeg;base64,<?php echo base64_encode( $profile['image'] ); ?>"  />

                                </br></br></br>
                                <form action="" method="post"> 
                                  <a href="updateadminprofile.php" class="btn btn-info">Update Profile</a> &nbsp;&nbsp;&nbsp;
