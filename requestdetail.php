...
<?php
  if (isset($_POST['delete'])) {
          ...
          header("location: bloodrequest.php",  true,  301 );  exit;
	   ...
	   <div class="col-md-offset-1 col-md-10" style="position: relative;top: -22px;">
	   		<div class="panel panel-default card" style="border-radius: 0px;">
	   			<div class="panel-body">
		              	<p><b>Patient - </b><b style='color:red;font-size:15px;'><?php echo $profile['name']; ?></b>      
     					 </p>
		              <div class='container-fluid' style='background-color:#D8D8D8;'>
                          ...
                          <tr>
                            <th><b>Needed Date</b></th>
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:red;'><?php echo $profile['ndate']; ?>&nbsp;</b></td>
                          </tr>

					              	<tr>
						              	<th><b>Unit</b></th>
						              	<th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
						              	<td><b style='color:#21610B;'><?php echo $profile['unit']; ?></b></td>
					              	</tr>
					              	
                          <tr>
                            <th><b>Disease Detail</b></th>
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:red;'><?php echo $profile['disease']; ?></b></td>
                          </tr>
                          <tr>
                            <th><b>Hospital Name</b></th>
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:#21610B;'><?php echo $profile['hname']; ?></b></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:#21610B;;'><?php echo $profile['dos']; ?></b></td>
                          </tr>
                            ...
                            <form action="" method="post">
                                    <a href="bloodrequest.php" class="btn btn-info">Back</a>  &nbsp;&nbsp;&nbsp;
                                  <input type="submit" name="delete" value="Delete" class="btn btn-info" onclick="return confirm('Are you sure ? You wanna Delete This Request ??')"></input> </br></br>  
                            </form>
