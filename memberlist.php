          ...
          <div class="col-md-12">
            <div class="table-responsive"> 
                ...
                <?php 
                  ...
                  $i=0;
                  foreach ($user->readAllmember() as $key => $value) {
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php 
                                        if ($user->getSession()) {
                                    ?>
                                    <a href="mprofile.php?id=<?php echo $value['id'];?>">View Profile</a>
                                    <?php }else{ ?>

                                    <a href="memberlist.php" onclick="alert('you must be logged in to View Profile .')">View Profile</a>
