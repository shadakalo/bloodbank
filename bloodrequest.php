          ...
          <div class="col-md-12">
            <div class="table-responsive"> 
                ...
                <?php 
                  ...
                  $i=0;
                  foreach ($user->readAllrequest() as $key => $value) {
                ...
                ?>
                                <tr>
                                  ...
                                  <td>
                                      <?php echo $value['disease'];?>
                                  </td>
                                  <td>
                                    <?php 
                                        if ($user->getSession()) {
                                    ?>
                                    <a href="requestdetail.php?id=<?php echo $value['id'];?>">View Detail</a>
                                    <?php }else{ ?>

                                    <a href="bloodrequest.php" onclick="alert('you must be logged in to View Profile .')">View Detail</a>
