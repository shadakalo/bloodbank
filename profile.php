...
<?php
  if (isset($_POST['delete'])) {
          ...
          $id = $_REQUEST['id'];
          $user->deleteUser($id);
          header("location: donorlist.php",  true,  301 );  exit;
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse navHeadercollapse">
        <ul class="nav navbar-nav navbar-right">   
          ...
          <li><a href="request.php"><span class="glyphicon glyphicon-tint"></span>&nbsp;&nbsp;Request For Blood</a></li>
          <li><a href="finddonor.php"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;Find a donor</a></li>
          <li><a href="index.php"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Doctor Articles</a></li>
	   ...
	   <div class="col-md-offset-1 col-md-10" style="position: relative;top: -22px;">
	   		<div class="panel panel-default card" style="border-radius: 0px;">
	   			<div class="panel-body">
		              	<p><b>Profile of - </b><b style='color:red;font-size:15px;'><?php echo $profile['name']; ?></b>      
     					 </p>
		              <div class='container-fluid' style='background-color:#D8D8D8;'>
                        ...
                        <?php 
                          ...
                          ?>
                            ...
                            <form action="" method="post">
                                    <a href="donorlist.php" class="btn btn-info">Back</a>  &nbsp;&nbsp;&nbsp;
                                  <input type="submit" name="delete" value="Delete" class="btn btn-info" onclick="return confirm('Are you sure ? You wanna Delete This Account ??')"></input> </br></br>  
                            </form>
                        ...
                        ?>
                        				 <a href="donorlist.php" class="btn btn-info">Back</a></br></br>  
