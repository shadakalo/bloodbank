...
<?php
  if (isset($_POST['delete'])) {
          ...
          header("location: memberlist.php",  true,  301 );  exit;
	   			...
	   			<div class="panel-body">
		              ...
		              <div class='container-fluid' style='background-color:#D8D8D8;'>
                          ...
                          <tr>
                            ...
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:#21610B;'><?php echo $profile['dob']; ?></b></td>
                          </tr>
                          ...
                          <tr>
                            <th><b>Why Join</b></th>
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:red;'><?php echo $profile['joini']; ?></b></td>
                          </tr>
                          <tr>
                            <th><b>Ocuupation</b></th>
                            <th>&nbsp; : &nbsp;&nbsp;&nbsp;</th>
                            <td><b style='color:#21610B;'><?php echo $profile['occu']; ?></b></td>
                          </tr>
